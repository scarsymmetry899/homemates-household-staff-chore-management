    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "grace-late": "hsl(var(--status-grace-late))",
      ...
      boxShadow: {
        ...
        card: "0px 4px 20px rgba(27, 28, 26, 0.05), 0px 1px 3px rgba(27, 28, 26, 0.03)",
        "card-hover": "0px 8px 32px rgba(27, 28, 26, 0.08), 0px 2px 6px rgba(27, 28, 26, 0.04)",
